...
def forum():
    ...
    if current_user.is_authenticated:
        current_user.page_viewing = '<a href="' + url_for("forum.forum") + '">Forum</a>'
        db.session.commit()
    ...
    # icons for forums
    subforums[0].icon = "bx bx-music"
    subforums[1].icon = "bx bx-message-detail"
    subforums[2].icon = "bx bx-git-branch"
    subforums[3].icon = "bx bxs-megaphone"
    subforums[4].icon = "bx bx-archive"
